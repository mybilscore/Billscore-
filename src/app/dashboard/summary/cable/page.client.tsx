// app/dashboard/summary/cable/page.client.tsx

"use client";

import { useState } from "react";
import { Tv, CheckCircle, Clock, XCircle, Activity, Search, Filter } from "lucide-react";
              ...
              <table className="w-full">
                <thead className="bg-gray-50 dark:bg-gray-800/50">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400">Smart Card</th>
                    <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400">Provider</th>
                ...
                <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                  {filteredTransactions.map((t) => (
                    <tr key={t.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                      ...
                      <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400">
                        {t.provider || t.product || "—"}
                      </td>
                      <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400">
                        {t.packageName || t.networkPlan || "—"}
                      </td>
