// app/dashboard/summary/airtime/page.client.tsx

"use client";

import { useState } from "react";
import { Phone, CheckCircle, Clock, XCircle, Activity, Search, Filter, ChevronDown, ChevronUp } from "lucide-react";
              ...
              <table className="w-full">
                <thead className="bg-gray-50 dark:bg-gray-800/50">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400">Network</th>
